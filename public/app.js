...
import('./js/app.js').then(module => {
    // The app will initialize automatically when the DOM is loaded
}).catch(error => {
    console.error('Failed to load modular app, falling back to legacy code:', error);
    
    // Fallback to legacy code if modules fail to load
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        console.log('🚀 NeoTalent Calorie Tracker initialized (legacy mode)');
    });
});
